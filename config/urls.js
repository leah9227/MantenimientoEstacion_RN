...
// Auth
export const AUTH_URL = `${BASE_URL}${API_URL}/oauth/token`;

//CardService
export const VALIDATE_CARD = `${BASE_URL}${API_URL}/ValidaTarjeta`

//CambiaEstado service
export const SERVICE_NAME = `ComandosPortal`
